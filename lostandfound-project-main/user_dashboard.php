      ...
      <form class="flex flex-col sm:flex-row items-center gap-4 w-full" method="GET" action="">
        ...
        <div class="relative w-full sm:w-auto">
          <select
            ...
            <option value="Aksesoris Pribadi" <?= $category === 'Pakaian' ? 'selected' : '' ?>>Pakaian</option>
            <option value="Aksesoris Pribadi" <?= $category === 'Botol Minum' ? 'selected' : '' ?>>Botol Minum</option>
            <option value="Aksesoris Pribadi" <?= $category === 'Kunci' ? 'selected' : '' ?>>Kunci</option>
          </select>
        </div>
