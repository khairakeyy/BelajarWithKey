        ...
        <div class="flex justify-between mb-4">
          <form method="GET" action="" class="flex space-x-4">
            ...
            <select name="category" class="p-2 bg-gray-100 rounded-lg border border-gray-300">
              ...
              <option value="perhiasan khusus" <?= isset($_GET['category']) && $_GET['category'] === 'personal' ? 'selected' : '' ?>>Perhiasan Khusus</option>
              <option value="elektronik" <?= isset($_GET['category']) && $_GET['category'] === 'electronics' ? 'selected' : '' ?>>Elektronik</option>
              <option value="buku & dokumen" <?= isset($_GET['category']) && $_GET['category'] === 'household' ? 'selected' : '' ?>>Buku & Dokumen</option>
              <option value="aksesoris pribadi" <?= isset($_GET['category']) && $_GET['category'] === 'household' ? 'selected' : '' ?>>Aksesoris Pribadi</option>
              <option value="pakaian" <?= isset($_GET['category']) && $_GET['category'] === 'household' ? 'selected' : '' ?>>Pakaian</option>
              <option value="botol minum" <?= isset($_GET['category']) && $_GET['category'] === 'household' ? 'selected' : '' ?>>Botol Minum</option>
              <option value="kunci" <?= isset($_GET['category']) && $_GET['category'] === 'household' ? 'selected' : '' ?>>Kunci</option>
            </select>
